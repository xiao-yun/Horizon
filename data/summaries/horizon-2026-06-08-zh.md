...
>
> ## AI 与工具
> 1. [第 29 届 IOCCC 2025 获奖作品揭晓：含 GameBoy 模拟器与 366 字节虚拟机](#item-ai-tools-1) ⭐️ 8.0/10 · HN · 05:47
> 2. [从瘾症、监狱和重罪中零基础重建生活与事业](#item-ai-tools-2) ⭐️ 7.0/10 · HN · 18:33
> 3. [Linear 为何如此之快？技术解析与社区反响](#item-ai-tools-3) ⭐️ 7.0/10 · HN · 19:01
> 4. [Lathe：利用 LLM 生成需手动输入的互动教程](#item-ai-tools-4) ⭐️ 7.0/10 · HN · 11:16
> 5. [用户呼吁 Anthropic 推出 Linux 版 Claude 桌面应用](#item-ai-tools-5) ⭐️ 7.0/10 · HN · 13:06
> ## 数据仓库
> 1. [Iceberg 提议虚拟字段优化半结构化查询](#item-data-warehouse-1) ⭐️ 8.0/10 · GitHub · 03:00
> 2. [Apache Iceberg 提出 File Format API 统一文件格式特性支持](#item-data-warehouse-2) ⭐️ 8.0/10 · GitHub · 11:57
> 3. [提议在 Iceberg REST 目录中添加表与列标签元数据支持](#item-data-warehouse-3) ⭐️ 7.0/10 · GitHub · 08:00
> 4. [Apache Iceberg 提案：新增 Variant 数据类型](#item-data-warehouse-4) ⭐️ 7.0/10 · GitHub · 12:52
> 5. [Iceberg REST API 提议增加查询参数裁剪快照和元数据日志](#item-data-warehouse-5) ⭐️ 7.0/10 · GitHub · 02:33
> 6. [Delta Lake 协议拟新增重定向功能提案](#item-data-warehouse-6) ⭐️ 7.0/10 · GitHub · 20:12
> 7. [Apache Hudi 提议支持分区软删除](#item-data-warehouse-7) ⭐️ 7.0/10 · GitHub · 22:43
> 8. [Apache Hudi 提出新型 Table APIs RFC 以改善查询引擎集成](#item-data-warehouse-8) ⭐️ 7.0/10 · GitHub · 23:15
> 9. [提交时捕获并发送聚合 Parquet 页脚指标](#item-data-warehouse-9) ⭐️ 6.0/10 · GitHub · 15:58
> 10. [提案在 LoadTableResponse 中暴露服务端分配的表 ID](#item-data-warehouse-10) ⭐️ 6.0/10 · GitHub · 19:56
> ## GitHub 趋势
> 1. [openai/plugins +262⭐: OpenAI 推出 ChatGPT 插件系统，社区高度关注](https://github.com/openai/plugins) ⭐️ 9.0/10 · GH Trending · 21:41
> 2. [NousResearch/hermes-agent +1117⭐: NousResearch/hermes-agent 单日获 1117 星：自进化 AI 代理框架](https://github.com/NousResearch/hermes-agent) ⭐️ 8.0/10 · GH Trending · 21:41
> 3. [mvanhorn/last30days-skill +1097⭐: last30days-skill：跨平台 AI 研究摘要技能今日获 1097 星](https://github.com/mvanhorn/last30days-skill) ⭐️ 7.0/10 · GH Trending · 21:41
> 4. [aaif-goose/goose +338⭐: 开源 AI 代理 Goose：自主完成代码安装、执行、编辑和测试](https://github.com/aaif-goose/goose) ⭐️ 7.0/10 · GH Trending · 21:41
> 5. [microsoft/pg_durable +314⭐: 微软开源 pg_durable：PostgreSQL 数据库内持久化执行工具](https://github.com/microsoft/pg_durable) ⭐️ 7.0/10 · GH Trending · 21:41
> 6. [RyanCodrai/turbovec +1533⭐: 基于 TurboQuant 的向量索引库 turbovec 走红 GitHub](https://github.com/RyanCodrai/turbovec) ⭐️ 6.0/10 · GH Trending · 21:41
> 7. [lfnovo/open-notebook +555⭐: 开源版 NotebookLM 项目 lfnovo/open-notebook 单日获 555 星](https://github.com/lfnovo/open-notebook) ⭐️ 6.0/10 · GH Trending · 21:41
> 8. [Crosstalk-Solutions/project-nomad +304⭐: Project NOMAD：自给自足的离线生存计算机](https://github.com/Crosstalk-Solutions/project-nomad) ⭐️ 6.0/10 · GH Trending · 21:41
> 9. [refactoringhq/tolaria +242⭐: Tolaria：TypeScript 编写的 Markdown 知识管理桌面应用获 242 星标](https://github.com/refactoringhq/tolaria) ⭐️ 6.0/10 · GH Trending · 21:41
> 10. [ggml-org/llama.cpp +197⭐: llama.cpp 在 GitHub 上今日获 197 星标](https://github.com/ggml-org/llama.cpp) ⭐️ 6.0/10 · GH Trending · 21:41

## AI 与工具

<a id="item-ai-tools-1"></a>
## [第 29 届 IOCCC 2025 获奖作品揭晓：含 GameBoy 模拟器与 366 字节虚拟机](https://www.ioccc.org/2025/) ⭐️ 8.0/10
...
<li><a href="https://github.com/ioccc-src/winner">GitHub - ioccc-src/winner: Winners of the International ... IOCCC 2025: How the obfuscated C contest evolved with open ... Winners Announced in 2026's 'International Obfuscated C Code ... The 29th International Obfuscated C Code Contest (IOCCC) 2025 ... What Is IOCCC (Internet Obfuscated C Code Contest)?</a></li>
...
## [从瘾症、监狱和重罪中零基础重建生活与事业](https://gavinray97.github.io/blog/building-from-zero-after-addiction-prison-felony) ⭐️ 7.0/10
...
## [Linear 为何如此之快？技术解析与社区反响](https://performance.dev/how-is-linear-so-fast-a-technical-breakdown) ⭐️ 7.0/10
...
<li><a href="https://news.ycombinator.com/item?id=43397640">Sync Engines Are the Future | Hacker News</a></li>
...
## [Lathe：利用 LLM 生成需手动输入的互动教程](https://github.com/devenjarvis/lathe) ⭐️ 7.0/10
...
## [用户呼吁 Anthropic 推出 Linux 版 Claude 桌面应用](https://github.com/anthropics/claude-code/issues/65697) ⭐️ 7.0/10
...
<li><a href="https://www.xda-developers.com/tested-every-linux-desktop-realized-fragmentation-problem-anymore/">I tested every Linux desktop and realized fragmentation isn't a problem anymore</a></li>
...
## [Iceberg 提议虚拟字段优化半结构化查询](https://github.com/apache/iceberg/issues/16064) ⭐️ 8.0/10
...
## [Apache Iceberg 提出 File Format API 统一文件格式特性支持](https://github.com/apache/iceberg/issues/12225) ⭐️ 8.0/10
...
## [提议在 Iceberg REST 目录中添加表与列标签元数据支持](https://github.com/apache/iceberg/issues/15521) ⭐️ 7.0/10
...
## [Apache Iceberg 提案：新增 Variant 数据类型](https://github.com/apache/iceberg/issues/10392) ⭐️ 7.0/10
...
## [Iceberg REST API 提议增加查询参数裁剪快照和元数据日志](https://github.com/apache/iceberg/issues/15947) ⭐️ 7.0/10
...
<li><a href="https://dev.to/alexmercedcoder/understanding-apache-icebergs-metadatajson-file-23f">Understanding Apache Iceberg 's metadata .json file - DEV Community</a></li>
...
## [Delta Lake 协议拟新增重定向功能提案](https://github.com/delta-io/delta/pull/3705) ⭐️ 7.0/10
...
<li><a href="https://github.com/delta-io/delta/blob/master/PROTOCOL.md">delta/PROTOCOL.md at master · delta-io/delta · GitHub What is Delta Lake in Databricks? | Databricks on AWS Delta Lake feature compatibility and protocols - Azure ... Inside the Delta Lake Transaction Log: From Write to Time Travel Delta Lake Table Properties: Every TBLPROPERTIES Setting ... Delta Lake connector — Trino 481 Documentation</a></li>
...
## [Apache Hudi 提议支持分区软删除](https://github.com/apache/hudi/issues/18774) ⭐️ 7.0/10
...
## [Apache Hudi 提出新型 Table APIs RFC 以改善查询引擎集成](https://github.com/apache/hudi/issues/15195) ⭐️ 7.0/10
...
## [提交时捕获并发送聚合 Parquet 页脚指标](https://github.com/apache/iceberg/issues/16675) ⭐️ 6.0/10
...
## [提案在 LoadTableResponse 中暴露服务端分配的表 ID](https://github.com/apache/iceberg/issues/16399) ⭐️ 6.0/10
