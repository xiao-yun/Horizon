...
>
> ## AI 与工具
> 1. [Anthropic 开源 AI 漏洞发现参考框架](#item-ai-tools-1) ⭐️ 8.0/10 · HN · 20:11
> 2. [Cloudflare 收购 Vite 创建者 VoidZero](#item-ai-tools-2) ⭐️ 8.0/10 · HN · 13:00
> 3. [当 AI 自我构建：Anthropic 报告递归自我改进进展](#item-ai-tools-3) ⭐️ 8.0/10 · HN · 16:20
> 4. [Meta 智能眼镜引入面部识别，隐私争议再起](#item-ai-tools-4) ⭐️ 8.0/10 · HN · 19:36
> 5. [复古科技育儿：HN 讨论限龄技术对孩子的影响](#item-ai-tools-5) ⭐️ 7.0/10 · HN · 16:02
> 6. [伯克利 CS 课程不及格率因 AI 使用激增](#item-ai-tools-6) ⭐️ 7.0/10 · HN · 00:18
> 7. [Uruky 推出图片搜索与 URL 重写功能，欧盟付费搜索引擎新选择](#item-ai-tools-7) ⭐️ 7.0/10 · HN · 08:56
> 8. [谷歌撤回“保持人类参与”声明引发 AI 伦理担忧](#item-ai-tools-8) ⭐️ 6.0/10 · Simon Willison · 16:38
> ## 数据仓库
> 1. [Apache Iceberg 提议虚拟字段优化 VARIANT 查询](#item-data-warehouse-1) ⭐️ 8.0/10 · GitHub · 03:00
> 2. [Apache Iceberg 提议新增 Variant 数据类型](#item-data-warehouse-2) ⭐️ 7.0/10 · GitHub · 12:52
> 3. [Apache Iceberg 提议文件格式 API 实现可插拔格式](#item-data-warehouse-3) ⭐️ 7.0/10 · GitHub · 11:57
> 4. [Iceberg loadTable 响应新增查询参数以修剪日志数组](#item-data-warehouse-4) ⭐️ 7.0/10 · GitHub · 02:33
> 5. [Delta Lake 重定向功能协议变更提案](#item-data-warehouse-5) ⭐️ 7.0/10 · GitHub · 20:12
> 6. [Apache Hudi 提出分区软删除支持提案](#item-data-warehouse-6) ⭐️ 7.0/10 · GitHub · 22:43
> 7. [提议在 Spark 提交时捕获并发送 Parquet footer 聚合指标](#item-data-warehouse-7) ⭐️ 6.0/10 · GitHub · 15:58
> 8. [提案：Iceberg Kafka Connect Worker 增加背压检测以保护协调器](#item-data-warehouse-8) ⭐️ 6.0/10 · GitHub · 00:01
> 9. [Apache Iceberg 提案为 REST 目录 API 增加标签元数据字段](#item-data-warehouse-9) ⭐️ 6.0/10 · GitHub · 08:00
> 10. [Apache Iceberg 提议为 loadView REST API 增加 ETag 及条件 GET 支持](#item-data-warehouse-10) ⭐️ 6.0/10 · GitHub · 02:23
> ## GitHub 趋势
> 1. [chopratejas/headroom +3139⭐: Headroom 开源：压缩 LLM 输入，减少 60-95% token 用量](https://github.com/chopratejas/headroom) ⭐️ 8.0/10 · GH Trending · 21:57
> 2. [NousResearch/hermes-agent +1951⭐: NousResearch 开源 AI 智能体 Hermes Agent 日增 1951 星标](https://github.com/NousResearch/hermes-agent) ⭐️ 7.0/10 · GH Trending · 21:57
> 3. [jwasham/coding-interview-university +740⭐: 编码面试大学项目今日新增 740 星](https://github.com/jwasham/coding-interview-university) ⭐️ 7.0/10 · GH Trending · 21:57
> 4. [Open-LLM-VTuber/Open-LLM-VTuber +583⭐: Open-LLM-VTuber：开源 LLM 语音交互与 Live2D 工具](https://github.com/Open-LLM-VTuber/Open-LLM-VTuber) ⭐️ 7.0/10 · GH Trending · 21:57
> 5. [lfnovo/open-notebook +482⭐: lfnovo/open-notebook：NotebookLM 的开源灵活替代方案](https://github.com/lfnovo/open-notebook) ⭐️ 7.0/10 · GH Trending · 21:57
> 6. [github/spec-kit +311⭐: GitHub 发布 spec-kit：规约驱动开发 Python 工具包](https://github.com/github/spec-kit) ⭐️ 7.0/10 · GH Trending · 21:57
> 7. [reconurge/flowsint +308⭐: Flowsint 网络安全图调查平台 GitHub 日增 308 星](https://github.com/reconurge/flowsint) ⭐️ 7.0/10 · GH Trending · 21:57
> 8. [NVIDIA/cosmos +244⭐: 英伟达开源 Cosmos 物理 AI 世界模型平台](https://github.com/NVIDIA/cosmos) ⭐️ 7.0/10 · GH Trending · 21:57
> 9. [github/copilot-sdk +107⭐: GitHub 发布了 Copilot SDK，用于集成 AI 代理](https://github.com/github/copilot-sdk) ⭐️ 7.0/10 · GH Trending · 21:57
> 10. [PaddlePaddle/PaddleOCR +105⭐: PaddleOCR 单日获 105 星，轻量级多语言 OCR 工具持续走热](https://github.com/PaddlePaddle/PaddleOCR) ⭐️ 7.0/10 · GH Trending · 21:57

## AI 与工具

<a id="item-ai-tools-1"></a>
## [Anthropic 开源 AI 漏洞发现参考框架](https://github.com/anthropics/defending-code-reference-harness) ⭐️ 8.0/10
...
## [当 AI 自我构建：Anthropic 报告递归自我改进进展](https://www.anthropic.com/institute/recursive-self-improvement) ⭐️ 8.0/10
...
## [Meta 智能眼镜引入面部识别，隐私争议再起](https://www.buchodi.com/meta-glasses-facial-recognition/) ⭐️ 8.0/10
...
## [复古科技育儿：HN 讨论限龄技术对孩子的影响](https://havenweb.org/2026/05/28/retro-tech.html) ⭐️ 7.0/10
...
## [伯克利 CS 课程不及格率因 AI 使用激增](https://www.dailycal.org/news/campus/academics/failing-grades-soar-as-professors-see-greater-ai-usage-dwindling-math-skills-in-uc-berkeley/article_16fad0bf-02cb-4b8c-8d88-888ffd9f8608.html) ⭐️ 7.0/10
...
## [Uruky 推出图片搜索与 URL 重写功能，欧盟付费搜索引擎新选择](https://uruky.com/?il=en) ⭐️ 7.0/10
...
<li><a href="https://en.wikipedia.org/wiki/Source-available_software">Source-available software - Wikipedia</a></li>
...
## [谷歌撤回“保持人类参与”声明引发 AI 伦理担忧](https://simonwillison.net/2026/Jun/4/a-slightly-different-version/#atom-everything) ⭐️ 6.0/10
...
## [Apache Iceberg 提议虚拟字段优化 VARIANT 查询](https://github.com/apache/iceberg/issues/16064) ⭐️ 8.0/10
...
## [Apache Iceberg 提议文件格式 API 实现可插拔格式](https://github.com/apache/iceberg/issues/12225) ⭐️ 7.0/10
...
## [Iceberg loadTable 响应新增查询参数以修剪日志数组](https://github.com/apache/iceberg/issues/15947) ⭐️ 7.0/10
...
<li><a href="https://iceberg.apache.org/docs/latest/maintenance/">Maintenance - Apache Iceberg™</a></li>
...
## [Delta Lake 重定向功能协议变更提案](https://github.com/delta-io/delta/pull/3705) ⭐️ 7.0/10
...
<details><summary>参考链接</summary>
<ul>
<li><a href="https://github.com/delta-io/delta/blob/master/PROTOCOL.md">delta/PROTOCOL.md at master · delta-io/delta · GitHub Configuration Properties - The Internals of Delta Lake Mastering Change Data Feed (CDF) in Delta Lake - Medium Usage — delta-rs documentation Delta Lake feature compatibility and protocols - Azure ...</a></li>
...
## [Apache Hudi 提出分区软删除支持提案](https://github.com/apache/hudi/issues/18774) ⭐️ 7.0/10
...
<details><summary>参考链接</summary>
<ul>
<li><a href="https://github.com/apache/hudi/issues/18774">[Discussion/Proposal WIP] Add support to soft delete ... - GitHub</a></li>
...
## [提议在 Spark 提交时捕获并发送 Parquet footer 聚合指标](https://github.com/apache/iceberg/issues/16675) ⭐️ 6.0/10
...
<li><a href="https://aws.amazon.com/blogs/big-data/monitoring-apache-iceberg-metadata-layer-using-aws-lambda-aws-glue-and-aws-cloudwatch/">Monitoring Apache Iceberg metadata layer using AWS Lambda, AWS Glue, and AWS CloudWatch | Amazon Web Services</a></li>
...
## [提案：Iceberg Kafka Connect Worker 增加背压检测以保护协调器](https://github.com/apache/iceberg/issues/16389) ⭐️ 6.0/10
...
<li><a href="https://www.tabular.io/blog/intro-kafka-connect/">Intro to the Iceberg Kafka Connect sink – Tabular</a></li>
...
## [Apache Iceberg 提案为 REST 目录 API 增加标签元数据字段](https://github.com/apache/iceberg/issues/15521) ⭐️ 6.0/10
...
## [Apache Iceberg 提议为 loadView REST API 增加 ETag 及条件 GET 支持](https://github.com/apache/iceberg/issues/15946) ⭐️ 6.0/10
...
<ul>
<li><a href="https://en.wikipedia.org/wiki/Apache_Iceberg">Apache Iceberg</a></li>
<li><a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Headers/ETag">ETag header - HTTP | MDN - MDN Web Docs Code sample</a></li>
