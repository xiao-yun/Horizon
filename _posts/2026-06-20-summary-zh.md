...
>
> ## AI 与工具
> 1. [Project Valhalla 十年磨一剑：JDK 28 迎来值类型革命](#item-ai-tools-1) ⭐️ 9.0/10 · HN · 06:35
> 2. [ATProto 中不存在“实例”概念](#item-ai-tools-2) ⭐️ 8.0/10 · HN · 15:10
> 3. [Google Workspace 安全策略可致使 Firefox 被拦截](#item-ai-tools-3) ⭐️ 8.0/10 · HN · 16:30
> 4. [新法案剑指政府施压压制合法网络言论](#item-ai-tools-4) ⭐️ 8.0/10 · HN · 17:34
> 5. [业余爱好者借助 Claude Code 可能破译线形文字 A](#item-ai-tools-5) ⭐️ 8.0/10 · HN · 16:04
> 6. [现代汽车全资收购波士顿动力，软银退出](#item-ai-tools-6) ⭐️ 7.0/10 · HN · 16:28
> 7. [Datasette Apps 插件：在 Datasette 中托管自定义 HTML 应用](#item-ai-tools-7) ⭐️ 7.0/10 · Simon Willison · 23:58
> 8. [Vocabowl 英语词汇测试应用遭用户批评](#item-ai-tools-8) ⭐️ 6.0/10 · HN · 13:51
> ## 数据仓库
> 1. [Apache Iceberg 提议新增 Variant 类型支持](#item-data-warehouse-1) ⭐️ 8.0/10 · GitHub · 12:52
> 2. [Apache Iceberg v4 规范拟新增 varchar 和 char 类型](#item-data-warehouse-2) ⭐️ 7.0/10 · GitHub · 13:55
> 3. [Apache Iceberg 提议增加水印和计算列元数据支持以改善 Flink 集成](#item-data-warehouse-3) ⭐️ 7.0/10 · GitHub · 03:53
> 4. [提议为 LoadTableResponse 增加可选标签字段](#item-data-warehouse-4) ⭐️ 7.0/10 · GitHub · 08:00
> 5. [Delta Lake 提议增加重定向协议变更规范](#item-data-warehouse-5) ⭐️ 7.0/10 · GitHub · 20:12
> 6. [Hudi 分区软删除提案：可恢复与可控清理](#item-data-warehouse-6) ⭐️ 7.0/10 · GitHub · 22:43
> 7. [Apache Hudi 提议新 Table API 精简查询引擎集成](#item-data-warehouse-7) ⭐️ 7.0/10 · GitHub · 23:15
> 8. [Confluent 发布 dbt 适配器，将 dbt 工作流引入流数据处理](#item-data-warehouse-8) ⭐️ 7.0/10 · Confluent Blog (Kafka/Flink) · 22:09
> 9. [Iceberg REST 目录新增按需元数据加载 API](#item-data-warehouse-9) ⭐️ 6.0/10 · GitHub · 00:50
> 10. [Iceberg V4 将引入文件标签元数据](#item-data-warehouse-10) ⭐️ 6.0/10 · GitHub · 00:44
> ## GitHub 趋势
> 1. [chopratejas/headroom +3938⭐: Headroom：将 LLM 输入压缩 60-95%以降低 token 用量](https://github.com/chopratejas/headroom) ⭐️ 8.0/10 · GH Trending · 21:39
> 2. [google-research/timesfm +1516⭐: 谷歌时间序列基础模型 TimesFM GitHub 单日获 1516 星](https://github.com/google-research/timesfm) ⭐️ 8.0/10 · GH Trending · 21:39
> 3. [DeusData/codebase-memory-mcp +1055⭐: DeusData/codebase-memory-mcp：高性能代码库知识图谱索引工具](https://github.com/DeusData/codebase-memory-mcp) ⭐️ 8.0/10 · GH Trending · 21:39
> 4. [penpot/penpot +318⭐: GitHub 上 Penpot 开源设计工具日增 318 星标](https://github.com/penpot/penpot) ⭐️ 7.0/10 · GH Trending · 21:39
> 5. [n0-computer/iroh +307⭐: 基于密钥寻址的模块化网络栈 iroh 日增 307 星](https://github.com/n0-computer/iroh) ⭐️ 7.0/10 · GH Trending · 21:39
> 6. [withastro/flue +305⭐: TypeScript 沙盒 Agent 框架 Flue 单日获 305 星](https://github.com/withastro/flue) ⭐️ 7.0/10 · GH Trending · 21:39
> 7. [calesthio/OpenMontage +236⭐: OpenMontage：开源自主智能视频制作系统发布](https://github.com/calesthio/OpenMontage) ⭐️ 7.0/10 · GH Trending · 21:39
> 8. [aishwaryanr/awesome-generative-ai-guide +155⭐: awesome-generative-ai-guide 仓库单日获 155 星](https://github.com/aishwaryanr/awesome-generative-ai-guide) ⭐️ 7.0/10 · GH Trending · 21:39
> 9. [obra/superpowers +1113⭐: obra/superpowers 单日获 1113 星，代理技能框架引关注](https://github.com/obra/superpowers) ⭐️ 6.0/10 · GH Trending · 21:39
> 10. [palmier-io/palmier-pro +749⭐: Palmier Pro：基于 AI 的 macOS 视频编辑器日获 749 星](https://github.com/palmier-io/palmier-pro) ⭐️ 6.0/10 · GH Trending · 21:39

## AI 与工具

<a id="item-ai-tools-1"></a>
## [Project Valhalla 十年磨一剑：JDK 28 迎来值类型革命](https://www.jvm-weekly.com/p/project-valhalla-explained-how-a) ⭐️ 9.0/10
...
## [ATProto 中不存在“实例”概念](https://overreacted.io/there-are-no-instances-in-atproto/) ⭐️ 8.0/10
...
## [Google Workspace 安全策略可致使 Firefox 被拦截](https://tales.fromprod.com/2026/169/google-workspace-threatening-to-block-firefox.html) ⭐️ 8.0/10
...
## [新法案剑指政府施压压制合法网络言论](https://www.eff.org/deeplinks/2026/06/new-bill-takes-aim-government-pressure-silence-lawful-online-speech) ⭐️ 8.0/10
...
## [业余爱好者借助 Claude Code 可能破译线形文字 A](https://aiclambake.com/clamtakes/linear-a/) ⭐️ 8.0/10
...
## [现代汽车全资收购波士顿动力，软银退出](https://startupfortune.com/hyundai-takes-full-control-of-boston-dynamics-as-softbank-exits-for-325-million/) ⭐️ 7.0/10
...
## [Datasette Apps 插件：在 Datasette 中托管自定义 HTML 应用](https://simonwillison.net/2026/Jun/18/datasette-apps/#atom-everything) ⭐️ 7.0/10
...
## [Vocabowl 英语词汇测试应用遭用户批评](https://vocabowl-870366514258.us-west1.run.app/) ⭐️ 6.0/10
...
## [Apache Iceberg 提议新增 Variant 类型支持](https://github.com/apache/iceberg/issues/10392) ⭐️ 8.0/10
...
## [Apache Iceberg 提议增加水印和计算列元数据支持以改善 Flink 集成](https://github.com/apache/iceberg/issues/16756) ⭐️ 7.0/10
...
## [提议为 LoadTableResponse 增加可选标签字段](https://github.com/apache/iceberg/issues/15521) ⭐️ 7.0/10

Apache Iceberg 社区提出在 REST Catalog 的 LoadTableResponse 中增加一个可选的`labels`字段，用于标准化传递表的所有权、分类等目录维护的元数据。 此举旨在消除不同目录供应商之间的扩展差异，使开源引擎能够统一消费这些上下文信息，提升互操作性，避免厂商锁定。 该字段为可选，不影响现有实现；它承载的是目录自身维护的上下文，而不是表格式本身的数据。具体字段定义尚未最终确定。

github · laskoviymishka · May 12, 08:00

**背景**: Apache Iceberg 是一种面向大规模分析数据湖的开源表格式。Iceberg REST Catalog 定义了目录服务与引擎之间的接口，负责表的发现和加载。`LoadTableResponse`是加载表时返回的响应，当前包含 schema、快照等信息，但缺乏传递目录端元数据（如所有权、分类）的标准字段。
...
## [Delta Lake 提议增加重定向协议变更规范](https://github.com/delta-io/delta/pull/3705) ⭐️ 7.0/10
...
## [Hudi 分区软删除提案：可恢复与可控清理](https://github.com/apache/hudi/issues/18774) ⭐️ 7.0/10
...
## [Apache Hudi 提议新 Table API 精简查询引擎集成](https://github.com/apache/hudi/issues/15195) ⭐️ 7.0/10
...
## [Confluent 发布 dbt 适配器，将 dbt 工作流引入流数据处理](https://www.confluent.io/blog/meeting-data-and-analytics-engineers-where-they-are-introducing-the-dbt-adapter-for-confluent-cloud/) ⭐️ 7.0/10
...
## [Iceberg REST 目录新增按需元数据加载 API](https://github.com/apache/iceberg/issues/11766) ⭐️ 6.0/10
...
## [Iceberg V4 将引入文件标签元数据](https://github.com/apache/iceberg/issues/14815) ⭐️ 6.0/10
