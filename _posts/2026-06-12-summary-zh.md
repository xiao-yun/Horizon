...
>
> ## AI 与工具
> 1. [Homebrew 6.0.0 发布，引入 Tap 信任与 Linux 沙箱等新特性](#item-ai-tools-1) ⭐️ 8.0/10 · HN · 13:24
> 2. [研究：LLM 在 95%兵棋推演中使用战术核武器](#item-ai-tools-2) ⭐️ 8.0/10 · HN · 19:54
> 3. [小米发布开源编码智能体 MiMoCode](#item-ai-tools-3) ⭐️ 8.0/10 · HN · 14:27
> 4. [加拿大民众请愿撤销侵犯隐私的 C-22 法案](#item-ai-tools-4) ⭐️ 8.0/10 · HN · 15:37
> 5. [AMD 修复 RCE 漏洞不力：仅用 CRC-32 代替签名验证](#item-ai-tools-5) ⭐️ 8.0/10 · HN · 16:03
> 6. [Zed 推出 DeltaDB，记录提交间的每次操作](#item-ai-tools-6) ⭐️ 8.0/10 · HN · 16:28
> 7. [分析揭示 Claude Fable 5 编程任务存在严重作弊与记忆问题](#item-ai-tools-7) ⭐️ 8.0/10 · HN · 16:03
> 8. [AI 编码热潮下，代码行数指标遭重新审视](#item-ai-tools-8) ⭐️ 8.0/10 · HN · 12:26
> 9. [datasette-agent 0.2a0 新增工具暂停提问功能](#item-ai-tools-9) ⭐️ 8.0/10 · Simon Willison · 23:57
> 10. [Datasette 1.0a33 发布：JSON API 扩展 ?_extra= 参数至查询和行](#item-ai-tools-10) ⭐️ 7.0/10 · Simon Willison · 15:26
> ## 数据仓库
> 1. [Apache Iceberg 提议新增 Variant 数据类型以原生支持半结构化数据](#item-data-warehouse-1) ⭐️ 8.0/10 · GitHub · 12:52
> 2. [Apache Iceberg 提议文件格式 API 以统一特性实现](#item-data-warehouse-2) ⭐️ 8.0/10 · GitHub · 11:57
> 3. [Delta Lake 协议新增重定向规范提案](#item-data-warehouse-3) ⭐️ 8.0/10 · GitHub · 20:12
> 4. [Databricks 发布 ZeroBus Ingest 系统：实现 PB 级遥测数据摄取](#item-data-warehouse-4) ⭐️ 8.0/10 · Databricks Blog · 19:45
> 5. [Databricks Spatial SQL 正式发布，集成 AI/BI Maps、Delta Sharing 与 Iceberg v3](#item-data-warehouse-5) ⭐️ 8.0/10 · Databricks Blog · 17:06
> 6. [Apache Iceberg 提案：支持 Flink 水印和计算列元数据](#item-data-warehouse-6) ⭐️ 7.0/10 · GitHub · 07:38
> 7. [Apache Iceberg Kafka Connect 提案增加协调器进度检测与背压](#item-data-warehouse-7) ⭐️ 7.0/10 · GitHub · 00:01
> 8. [Iceberg REST Catalog 提议增加标准化标签元数据](#item-data-warehouse-8) ⭐️ 7.0/10 · GitHub · 08:00
> 9. [Apache Iceberg 提议为 VARIANT 列添加虚拟字段元数据](#item-data-warehouse-9) ⭐️ 7.0/10 · GitHub · 03:00
> 10. [停止构建数据产品，开始构建数据服务](#item-data-warehouse-10) ⭐️ 7.0/10 · Databricks Blog · 08:46
> ## GitHub 趋势
> 1. [addyosmani/agent-skills +3275⭐: Addy Osmani 的 AI 编码代理工程技巧合集日增 3275 星](https://github.com/addyosmani/agent-skills) ⭐️ 8.0/10 · GH Trending · 22:20
> 2. [apple/container +2419⭐: 苹果发布 Swift 容器工具，为 Apple silicon Mac 带来原生 Linux 容器支持](https://github.com/apple/container) ⭐️ 8.0/10 · GH Trending · 22:20
> 3. [obra/superpowers +1323⭐: obra/superpowers：面向编程 Agent 的技能框架与方法论](https://github.com/obra/superpowers) ⭐️ 8.0/10 · GH Trending · 22:20
> 4. [x1xhlol/system-prompts-and-models-of-ai-tools +369⭐: AI 工具系统提示与模型合集仓库日获 369 星](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) ⭐️ 8.0/10 · GH Trending · 22:20
> 5. [NVIDIA/SkillSpector +308⭐: NVIDIA 推出 AI 代理技能安全扫描器 SkillSpector](https://github.com/NVIDIA/SkillSpector) ⭐️ 8.0/10 · GH Trending · 22:20
> 6. [phuryn/pm-skills +1944⭐: phuryn/pm-skills 仓库上线，提供 100+产品管理智能体技能](https://github.com/phuryn/pm-skills) ⭐️ 7.0/10 · GH Trending · 22:20
> 7. [soxoj/maigret +665⭐: Maigret 工具 GitHub 单日获 665 星，OSINT 热度高涨](https://github.com/soxoj/maigret) ⭐️ 7.0/10 · GH Trending · 22:20
> 8. [refactoringhq/tolaria +604⭐: Tolaria：TypeScript Markdown 知识库桌面应用单日获星 604 枚](https://github.com/refactoringhq/tolaria) ⭐️ 7.0/10 · GH Trending · 22:20
> 9. [masterking32/MasterDnsVPN +510⭐: MasterDnsVPN 今日获 510 星：Go 语言 DNS 隧道 VPN 工具](https://github.com/masterking32/MasterDnsVPN) ⭐️ 7.0/10 · GH Trending · 22:20
> 10. [kenn-io/agentsview +98⭐: agentsview：本地优先，百倍快于 ccusage 的代理分析工具](https://github.com/kenn-io/agentsview) ⭐️ 7.0/10 · GH Trending · 22:20

## AI 与工具

<a id="item-ai-tools-1"></a>
## [Homebrew 6.0.0 发布，引入 Tap 信任与 Linux 沙箱等新特性](https://brew.sh/2026/06/11/homebrew-6.0.0/) ⭐️ 8.0/10
...
<li><a href="https://news.linxi.com.au/news/homebrew-600-introduces-mandatory-tap-trust-and-macos-27-support">Homebrew 6.0.0 release: Tap trust, Linux sandboxing, macOS 27 support ...</a></li>
...
## [研究：LLM 在 95%兵棋推演中使用战术核武器](https://www.kennethpayne.uk/p/shall-we-play-a-game) ⭐️ 8.0/10
...
## [小米发布开源编码智能体 MiMoCode](https://mimo.xiaomi.com/mimocode) ⭐️ 8.0/10
...
## [加拿大民众请愿撤销侵犯隐私的 C-22 法案](https://www.ourcommons.ca/petitions/en/Petition/Sign/e-7416) ⭐️ 8.0/10
...
## [AMD 修复 RCE 漏洞不力：仅用 CRC-32 代替签名验证](https://mrbruh.com/amd2/) ⭐️ 8.0/10
...
## [Zed 推出 DeltaDB，记录提交间的每次操作](https://zed.dev/blog/introducing-deltadb) ⭐️ 8.0/10
...
## [分析揭示 Claude Fable 5 编程任务存在严重作弊与记忆问题](https://www.endorlabs.com/learn/claude-fable-5-mythos-grade-hype) ⭐️ 8.0/10
...
<li><a href="https://www.researchgate.net/publication/392683510_Memorization_in_LLM-Based_Program_Repair">Memorization in LLM-Based Program Repair</a></li>
...
## [AI 编码热潮下，代码行数指标遭重新审视](https://curlewis.co.nz/posts/lines-of-code-got-a-better-publicist/) ⭐️ 8.0/10
...
## [datasette-agent 0.2a0 新增工具暂停提问功能](https://simonwillison.net/2026/Jun/10/datasette-agent/#atom-everything) ⭐️ 8.0/10
...
## [Datasette 1.0a33 发布：JSON API 扩展 ?_extra= 参数至查询和行](https://simonwillison.net/2026/Jun/11/datasette/#atom-everything) ⭐️ 7.0/10
...
## [Apache Iceberg 提议新增 Variant 数据类型以原生支持半结构化数据](https://github.com/apache/iceberg/issues/10392) ⭐️ 8.0/10
...
## [Apache Iceberg 提议文件格式 API 以统一特性实现](https://github.com/apache/iceberg/issues/12225) ⭐️ 8.0/10
...
## [Databricks 发布 ZeroBus Ingest 系统：实现 PB 级遥测数据摄取](https://www.databricks.com/blog/ingesting-milky-way-petabyte-scale-zerobus-ingest) ⭐️ 8.0/10
...
<details><summary>参考链接</summary>
<ul>
<li><a href="https://docs.databricks.com/aws/en/ingestion/zerobus-overview">Zerobus Ingest connector overview - Databricks on AWS</a></li>
<li><a href="https://anujsen02.medium.com/zerobus-ingest-on-databricks-a93a2dba5319">ZeroBus Ingest on Databricks. Simplifying Real-Time Streaming ...</a></li>
...
## [Databricks Spatial SQL 正式发布，集成 AI/BI Maps、Delta Sharing 与 Iceberg v3](https://www.databricks.com/blog/geospatial-unbounded-spatial-sql-ga-aibi-maps-delta-sharing-and-iceberg-v3) ⭐️ 8.0/10
...
<details><summary>参考链接</summary>
<ul>
<li><a href="https://www.databricks.com/blog/introducing-spatial-sql-databricks-80-functions-high-performance-geospatial-analytics">Introducing Spatial SQL in Databricks: 80+ Functions for High ...</a></li>
<li><a href="https://www.databricks.com/blog/unity-catalog-and-next-era-apache-icebergtm">Advancing Apache Iceberg on Databricks: Iceberg v3 GA, Open Sharing, and Unified Governance | Databricks Blog</a></li>
...
## [Apache Iceberg 提案：支持 Flink 水印和计算列元数据](https://github.com/apache/iceberg/issues/16756) ⭐️ 7.0/10
...
## [Apache Iceberg Kafka Connect 提案增加协调器进度检测与背压](https://github.com/apache/iceberg/issues/16389) ⭐️ 7.0/10
...
## [Iceberg REST Catalog 提议增加标准化标签元数据](https://github.com/apache/iceberg/issues/15521) ⭐️ 7.0/10
...
## [停止构建数据产品，开始构建数据服务](https://www.databricks.com/blog/stop-building-data-products-start-building-data-services) ⭐️ 7.0/10
...
<details><summary>参考链接</summary>
<ul>
<li><a href="https://en.wikipedia.org/wiki/Data_product">Data product - Wikipedia</a></li>
<li><a href="https://cloud.google.com/discover/what-are-data-products">What are data products? Benefits and use cases | Google Cloud</a></li>
<li><a href="https://www.ibm.com/think/topics/data-architecture">What Is a Data Architecture? | IBM</a></li>
