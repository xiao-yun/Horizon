...
>
> ## AI 与工具
> 1. [Valve 正式发布新款 Steam Machine 游戏主机](#item-ai-tools-1) ⭐️ 8.0/10 · HN · 17:09
> 2. [Moebius: 0.2B 参数图像修复模型宣称达 10B 级性能](#item-ai-tools-2) ⭐️ 8.0/10 · HN · 13:53
> 3. [加拿大计划未来 15 年建造最多 10 座新核反应堆](#item-ai-tools-3) ⭐️ 8.0/10 · HN · 19:06
> 4. [OpenAI Codex CLI 日志缺陷可致 SSD 写入数 TB 数据](#item-ai-tools-4) ⭐️ 8.0/10 · HN · 07:30
> 5. [Flock 安全摄像头被警察跟踪女性，亟需搜查令要求](#item-ai-tools-5) ⭐️ 8.0/10 · HN · 19:13
> 6. [Mitchell Hashimoto 承诺向 Zig 软件基金会再捐 40 万美元](#item-ai-tools-6) ⭐️ 8.0/10 · HN · 13:43
> 7. [sqlite-utils 4.0rc1 引入迁移和嵌套事务](#item-ai-tools-7) ⭐️ 8.0/10 · Simon Willison · 23:30
> 8. [Hacker News 热议 GLM 5.2 与 Opus 单次编码基准测试](#item-ai-tools-8) ⭐️ 7.0/10 · HN · 07:22
> 9. [Cloudflare 新增临时 Workers 匿名部署功能](#item-ai-tools-9) ⭐️ 7.0/10 · Simon Willison · 22:01
> ## 数据仓库
> 1. [Apache Iceberg 提议新增 Variant 数据类型](#item-data-warehouse-1) ⭐️ 8.0/10 · GitHub · 12:52
> 2. [Apache Hudi RFC 提出新表 API 以改进查询引擎集成](#item-data-warehouse-2) ⭐️ 8.0/10 · GitHub · 23:15
> 3. [Apache Iceberg REST 目录新增新鲜度感知表加载功能](#item-data-warehouse-3) ⭐️ 7.0/10 · GitHub · 00:50
> 4. [Apache Iceberg Flink 集成拟支持水印与计算列元数据](#item-data-warehouse-4) ⭐️ 7.0/10 · GitHub · 03:53
> 5. [Delta Lake 协议新增重定向功能提案](#item-data-warehouse-5) ⭐️ 7.0/10 · GitHub · 20:12
> 6. [Apache Iceberg 计划在 v4 规范中添加 varchar 和 char 类型](#item-data-warehouse-6) ⭐️ 6.0/10 · GitHub · 13:55
> 7. [提交时捕获并发射 Parquet 页脚聚合指标](#item-data-warehouse-7) ⭐️ 6.0/10 · GitHub · 15:58
> 8. [Apache Iceberg 拟在 REST 响应中暴露服务器分配的表标识符](#item-data-warehouse-8) ⭐️ 6.0/10 · GitHub · 19:56
> 9. [Iceberg REST 目录拟增加标签元数据字段](#item-data-warehouse-9) ⭐️ 6.0/10 · GitHub · 08:00
> 10. [Iceberg REST API 提议新增 recursive 参数以简化命名空间列表获取](#item-data-warehouse-10) ⭐️ 6.0/10 · GitHub · 00:37
> ## GitHub 趋势
> 1. [DeusData/codebase-memory-mcp +1186⭐: DeusData/codebase-memory-mcp：亚毫秒级代码智能 MCP 服务器](https://github.com/DeusData/codebase-memory-mcp) ⭐️ 8.0/10 · GH Trending · 22:19
> 2. [bytedance/deer-flow +736⭐: 字节跳动开源长时 SuperAgent 框架 DeerFlow 一日获 736 星](https://github.com/bytedance/deer-flow) ⭐️ 8.0/10 · GH Trending · 22:19
> 3. [lyogavin/airllm +187⭐: AirLLM 实现单张 4GB GPU 运行 70B 大模型推理](https://github.com/lyogavin/airllm) ⭐️ 8.0/10 · GH Trending · 22:19
> 4. [calesthio/OpenMontage +2935⭐: OpenMontage：全球首个开源智能体视频制作系统](https://github.com/calesthio/OpenMontage) ⭐️ 7.0/10 · GH Trending · 22:19
> 5. [mukul975/Anthropic-Cybersecurity-Skills +957⭐: Anthropic 网络安全技能集开源项目单日获 957 星](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) ⭐️ 7.0/10 · GH Trending · 22:19
> 6. [firecrawl/firecrawl +736⭐: firecrawl/firecrawl 单日获星 736 个，成热门网页抓取 API](https://github.com/firecrawl/firecrawl) ⭐️ 7.0/10 · GH Trending · 22:19
> 7. [Stirling-Tools/Stirling-PDF +691⭐: Stirling-PDF 单日获 691 星，成 GitHub 热门 PDF 工具](https://github.com/Stirling-Tools/Stirling-PDF) ⭐️ 7.0/10 · GH Trending · 22:19
> 8. [garrytan/gstack +649⭐: Garry Tan 发布 gstack：23 个 Claude Code 开发角色工具](https://github.com/garrytan/gstack) ⭐️ 7.0/10 · GH Trending · 22:19
> 9. [tursodatabase/turso +538⭐: Rust 嵌入式数据库 Turso 单日获 538 星](https://github.com/tursodatabase/turso) ⭐️ 7.0/10 · GH Trending · 22:19
> 10. [jamiepine/voicebox +508⭐: 开源 AI 语音工作室 Voicebox 单日获星 508 颗](https://github.com/jamiepine/voicebox) ⭐️ 7.0/10 · GH Trending · 22:19

## AI 与工具

<a id="item-ai-tools-1"></a>
## [Valve 正式发布新款 Steam Machine 游戏主机](https://store.steampowered.com/news/group/45479024/view/685257114654870245) ⭐️ 8.0/10
...
## [Moebius: 0.2B 参数图像修复模型宣称达 10B 级性能](https://hustvl.github.io/Moebius/) ⭐️ 8.0/10
...
## [加拿大计划未来 15 年建造最多 10 座新核反应堆](https://www.cbc.ca/news/politics/federal-nuclear-strategy-9.7244509) ⭐️ 8.0/10
...
## [OpenAI Codex CLI 日志缺陷可致 SSD 写入数 TB 数据](https://github.com/openai/codex/issues/28224) ⭐️ 8.0/10
...
## [Flock 安全摄像头被警察跟踪女性，亟需搜查令要求](https://ipvm.com/reports/police-chiefs-track) ⭐️ 8.0/10
...
## [Mitchell Hashimoto 承诺向 Zig 软件基金会再捐 40 万美元](https://mitchellh.com/writing/zig-donation-2026) ⭐️ 8.0/10
...
## [Hacker News 热议 GLM 5.2 与 Opus 单次编码基准测试](https://techstackups.com/comparisons/glm-5.2-vs-opus/) ⭐️ 7.0/10
...
## [Cloudflare 新增临时 Workers 匿名部署功能](https://simonwillison.net/2026/Jun/21/temporary-cloudflare-accounts/#atom-everything) ⭐️ 7.0/10
...
## [Apache Hudi RFC 提出新表 API 以改进查询引擎集成](https://github.com/apache/hudi/issues/15195) ⭐️ 8.0/10
...
## [Apache Iceberg Flink 集成拟支持水印与计算列元数据](https://github.com/apache/iceberg/issues/16756) ⭐️ 7.0/10
...
## [Apache Iceberg 计划在 v4 规范中添加 varchar 和 char 类型](https://github.com/apache/iceberg/pull/16829) ⭐️ 6.0/10
...
## [提交时捕获并发射 Parquet 页脚聚合指标](https://github.com/apache/iceberg/issues/16675) ⭐️ 6.0/10
...
## [Apache Iceberg 拟在 REST 响应中暴露服务器分配的表标识符](https://github.com/apache/iceberg/issues/16399) ⭐️ 6.0/10
...
## [Iceberg REST 目录拟增加标签元数据字段](https://github.com/apache/iceberg/issues/15521) ⭐️ 6.0/10
...
## [Iceberg REST API 提议新增 recursive 参数以简化命名空间列表获取](https://github.com/apache/iceberg/issues/13453) ⭐️ 6.0/10
