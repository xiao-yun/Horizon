...
>
> ## AI 与工具
> 1. [SpaceX 拟以 600 亿美元收购 AI 编程工具 Cursor](#item-ai-tools-1) ⭐️ 9.0/10 · HN · 10:44
> 2. [运行本地大语言模型已变得实用可行](#item-ai-tools-2) ⭐️ 8.0/10 · HN · 14:36
> 3. [机械手表工作原理的交互式深度解析](#item-ai-tools-3) ⭐️ 8.0/10 · HN · 11:26
> 4. [牦牛剃毛的乐趣与陷阱：软件开发中的深层反思（2019）](#item-ai-tools-4) ⭐️ 8.0/10 · HN · 14:26
> 5. [内部政治与 AI 狂热被指侵蚀 Meta 工程文化](#item-ai-tools-5) ⭐️ 8.0/10 · HN · 16:42
> 6. [GrapheneOS 已移植到 Android 17，官方版本即将发布](#item-ai-tools-6) ⭐️ 7.0/10 · HN · 20:34
> 7. [停止在浏览器会话中使用 JWT](#item-ai-tools-7) ⭐️ 7.0/10 · HN · 16:49
> 8. [苹果 Hide My Email 功能更新或削弱隐私保护](#item-ai-tools-8) ⭐️ 7.0/10 · HN · 18:37
> 9. [苹果车辆运动提示动画点缓解晕车](#item-ai-tools-9) ⭐️ 7.0/10 · HN · 16:12
> 10. [《杀戮尖塔 2》定制 PRNG 实现跨平台种子一致性](#item-ai-tools-10) ⭐️ 7.0/10 · HN · 09:46
> ## 数据仓库
> 1. [Apache Iceberg 提议新增 Variant 数据类型](#item-data-warehouse-1) ⭐️ 8.0/10 · GitHub · 12:52
> 2. [利用有状态流处理开发合规 AI 代理](#item-data-warehouse-2) ⭐️ 8.0/10 · Confluent Blog (Kafka/Flink) · 21:40
> 3. [Databricks 为 Lakebase Postgres 推出 Lakebase Search 混合检索](#item-data-warehouse-3) ⭐️ 8.0/10 · Databricks Blog · 12:45
> 4. [Apache Iceberg 提议 REST 目录新鲜度感知表加载](#item-data-warehouse-4) ⭐️ 7.0/10 · GitHub · 00:50
> 5. [Apache Iceberg 提议为 Flink 增加水印与计算列支持](#item-data-warehouse-5) ⭐️ 7.0/10 · GitHub · 03:53
> 6. [Apache Iceberg 提议在提交时捕获并发送 Parquet 页脚指标](#item-data-warehouse-6) ⭐️ 7.0/10 · GitHub · 15:58
> 7. [Apache Iceberg 提议为 VARIANT 列加入虚拟字段元数据](#item-data-warehouse-7) ⭐️ 7.0/10 · GitHub · 03:00
> 8. [Databricks 发布 OpenSharing：面向 Agentic AI 时代的 Delta Sharing 升级版](#item-data-warehouse-8) ⭐️ 7.0/10 · Databricks Blog · 17:40
> 9. [Databricks 推出应用市场，简化 AI 应用发现与部署](#item-data-warehouse-9) ⭐️ 7.0/10 · Databricks Blog · 17:30
> 10. [Data + AI Summit 2026 上 Unity Catalog 更新，聚焦大规模 AI 代理](#item-data-warehouse-10) ⭐️ 7.0/10 · Databricks Blog · 13:25
> ## GitHub 趋势
> 1. [n0-computer/iroh +326⭐: iroh：用公钥拨号的 Rust 模块化网络栈](https://github.com/n0-computer/iroh) ⭐️ 8.0/10 · GH Trending · 22:25
> 2. [meshery/meshery +229⭐: Meshery 云原生管理器单日揽获 229 星](https://github.com/meshery/meshery) ⭐️ 8.0/10 · GH Trending · 22:25
> 3. [OpenBMB/VoxCPM +413⭐: OpenBMB 推出 VoxCPM2：无分词器多语种语音合成与克隆模型](https://github.com/OpenBMB/VoxCPM) ⭐️ 7.0/10 · GH Trending · 22:25
> 4. [alibaba/zvec +188⭐: 阿里巴巴开源轻量级进程内向量数据库 zvec](https://github.com/alibaba/zvec) ⭐️ 7.0/10 · GH Trending · 22:25
> 5. [teslamate-org/teslamate +214⭐: TeslaMate 单日获 214 星](https://github.com/teslamate-org/teslamate) ⭐️ 6.0/10 · GH Trending · 22:25
> 6. [rmyndharis/OpenWA +185⭐: OpenWA 开源 WhatsApp 网关单日获 185 星](https://github.com/rmyndharis/OpenWA) ⭐️ 6.0/10 · GH Trending · 22:25
> 7. [Universal-Debloater-Alliance/universal-android-debloater-next-generation +146⭐: 跨平台 Rust 安卓去臃肿 GUI 工具](https://github.com/Universal-Debloater-Alliance/universal-android-debloater-next-generation) ⭐️ 6.0/10 · GH Trending · 22:25
> 8. [swc-project/swc +21⭐: swc（Rust 编写的 JS 编译器）今日获星 21 枚](https://github.com/swc-project/swc) ⭐️ 6.0/10 · GH Trending · 22:25

## AI 与工具

<a id="item-ai-tools-1"></a>
## [SpaceX 拟以 600 亿美元收购 AI 编程工具 Cursor](https://www.reuters.com/legal/transactional/spacex-buy-anysphere-60-billion-2026-06-16/) ⭐️ 9.0/10
...
## [运行本地大语言模型已变得实用可行](https://vickiboykis.com/2026/06/15/running-local-models-is-good-now/) ⭐️ 8.0/10
...
## [牦牛剃毛的乐趣与陷阱：软件开发中的深层反思（2019）](https://parksb.github.io/en/article/32.html) ⭐️ 8.0/10
...
## [内部政治与 AI 狂热被指侵蚀 Meta 工程文化](https://newsletter.pragmaticengineer.com/p/why-is-meta-destroying-its-engineering) ⭐️ 8.0/10
...
## [苹果 Hide My Email 功能更新或削弱隐私保护](https://arseniyshestakov.com/2026/06/16/apple-is-about-to-make-hide-my-email-useless/) ⭐️ 7.0/10
...
## [苹果车辆运动提示动画点缓解晕车](https://www.theverge.com/tech/942854/apple-vehicle-motion-cues-review-really-work) ⭐️ 7.0/10
...
## [《杀戮尖塔 2》定制 PRNG 实现跨平台种子一致性](https://tck.mn/blog/correlated-randomness-sts2/) ⭐️ 7.0/10
...
## [利用有状态流处理开发合规 AI 代理](https://www.confluent.io/blog/compliant-ai-agents-stateful-stream-processing/) ⭐️ 8.0/10
...
## [Databricks 为 Lakebase Postgres 推出 Lakebase Search 混合检索](https://www.databricks.com/blog/announcing-lakebase-search-agent-native-retrieval-built-lakebase-postgres) ⭐️ 8.0/10
...
## [Apache Iceberg 提议 REST 目录新鲜度感知表加载](https://github.com/apache/iceberg/issues/11766) ⭐️ 7.0/10
...
## [Apache Iceberg 提议为 Flink 增加水印与计算列支持](https://github.com/apache/iceberg/issues/16756) ⭐️ 7.0/10
...
## [Apache Iceberg 提议在提交时捕获并发送 Parquet 页脚指标](https://github.com/apache/iceberg/issues/16675) ⭐️ 7.0/10
...
## [Apache Iceberg 提议为 VARIANT 列加入虚拟字段元数据](https://github.com/apache/iceberg/issues/16064) ⭐️ 7.0/10
...
## [Databricks 发布 OpenSharing：面向 Agentic AI 时代的 Delta Sharing 升级版](https://www.databricks.com/blog/introducing-opensharing-next-evolution-delta-sharing-agentic-era) ⭐️ 7.0/10
...
## [Databricks 推出应用市场，简化 AI 应用发现与部署](https://www.databricks.com/blog/announcing-apps-databricks-marketplace) ⭐️ 7.0/10
...
## [Data + AI Summit 2026 上 Unity Catalog 更新，聚焦大规模 AI 代理](https://www.databricks.com/blog/whats-new-unity-catalog-data-ai-summit-2026) ⭐️ 7.0/10
