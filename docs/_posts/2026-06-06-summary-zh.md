...
>
> ## AI 与工具
> 1. [微软开源 pg_durable：PostgreSQL 内持久执行扩展](#item-ai-tools-1) ⭐️ 8.0/10 · HN · 15:59
> 2. [谷歌发布 Gemma 4 量化感知训练模型，优化移动与笔记本效率](#item-ai-tools-2) ⭐️ 8.0/10 · HN · 16:18
> 3. [Claude 是否导致 rsync 漏洞增加？](#item-ai-tools-3) ⭐️ 8.0/10 · HN · 12:43
> 4. [我测试了家用实验室中的每一款 IP KVM](#item-ai-tools-4) ⭐️ 8.0/10 · HN · 14:30
> 5. [Ladybird 浏览器停止接受公开 PR，强化代码责任](#item-ai-tools-5) ⭐️ 8.0/10 · Simon Willison · 11:10
> 6. [AI 爱好者与怀疑者的竞赛：时间与熵的博弈](#item-ai-tools-6) ⭐️ 8.0/10 · Simon Willison · 23:55
> 7. [关于 Conventional Commits 重形式轻内容的争论引发热议](#item-ai-tools-7) ⭐️ 7.0/10 · HN · 15:39
> 8. [国际空间站空气泄漏：宇航员紧急避难后安全返回](#item-ai-tools-8) ⭐️ 6.0/10 · HN · 15:00
> 9. [一位创始人分享三个最糟糕的风投经历](#item-ai-tools-9) ⭐️ 6.0/10 · HN · 19:08
> 10. [毛细作用防堵塞的热淡化新法：无废水制取淡水](#item-ai-tools-10) ⭐️ 6.0/10 · HN · 15:04
> ## 数据仓库
> 1. [Apache Iceberg 提案：为 VARIANT 列添加虚拟字段元数据以优化查询](#item-data-warehouse-1) ⭐️ 8.0/10 · GitHub · 03:00
> 2. [ClickHouse 通过并行哈希连接等优化实现 26 倍连接性能提升](#item-data-warehouse-2) ⭐️ 8.0/10 · ClickHouse Blog · 22:25
> 3. [Apache Iceberg 提议新增 Variant 数据类型](#item-data-warehouse-3) ⭐️ 7.0/10 · GitHub · 12:52
> 4. [提议引入文件格式 API 以统一 Iceberg V3 特性支持](#item-data-warehouse-4) ⭐️ 7.0/10 · GitHub · 11:57
> 5. [提议为 Iceberg REST API loadTable 响应添加修剪快照和元数据日志的查询参数](#item-data-warehouse-5) ⭐️ 7.0/10 · GitHub · 02:33
> 6. [Apache Hudi 提交 RFC 提出新 Table APIs 优化查询引擎集成](#item-data-warehouse-6) ⭐️ 7.0/10 · GitHub · 23:15
> 7. [ClickStack 事件增量加速慢追踪的根因定位](#item-data-warehouse-7) ⭐️ 7.0/10 · ClickHouse Blog · 11:24
> 8. [提案：Kafka Connect Worker 需检测协调器进度以实施背压](#item-data-warehouse-8) ⭐️ 6.0/10 · GitHub · 00:01
> 9. [Apache Iceberg 拟在 LoadTableResponse 中暴露服务器分配的表 ID](#item-data-warehouse-9) ⭐️ 6.0/10 · GitHub · 19:56
> 10. [Iceberg REST Catalog 提议新增表与列标签字段](#item-data-warehouse-10) ⭐️ 6.0/10 · GitHub · 08:00
> ## GitHub 趋势
> 1. [chopratejas/headroom +2503⭐: headroom：大幅压缩 LLM 输入，节省 60-95% token 用量](https://github.com/chopratejas/headroom) ⭐️ 8.0/10 · GH Trending · 21:51
> 2. [PaddlePaddle/PaddleOCR +755⭐: PaddleOCR 单日获 755 颗星，引领文档 OCR 新潮流](https://github.com/PaddlePaddle/PaddleOCR) ⭐️ 8.0/10 · GH Trending · 21:51
> 3. [NVIDIA/cosmos +494⭐: NVIDIA/cosmos 单日获 494 星，开源物理 AI 世界模型平台](https://github.com/NVIDIA/cosmos) ⭐️ 8.0/10 · GH Trending · 21:51
> 4. [aquasecurity/trivy +208⭐: Trivy 安全扫描工具单日 Star 数暴增 208 个](https://github.com/aquasecurity/trivy) ⭐️ 8.0/10 · GH Trending · 21:51
> 5. [NousResearch/hermes-agent +1821⭐: NousResearch 发布 hermes-agent，单日获 1821 星](https://github.com/NousResearch/hermes-agent) ⭐️ 7.0/10 · GH Trending · 21:51
> 6. [lfnovo/open-notebook +1142⭐: 开源 NotebookLM 实现 open-notebook 日增 1142 星](https://github.com/lfnovo/open-notebook) ⭐️ 7.0/10 · GH Trending · 21:51
> 7. [jwasham/coding-interview-university +757⭐: jwasham/coding-interview-university 日增 757 星，程序员面试准备资源走红](https://github.com/jwasham/coding-interview-university) ⭐️ 7.0/10 · GH Trending · 21:51
> 8. [CopilotKit/CopilotKit +350⭐: CopilotKit 日增 350 星：构建代理驱动界面的前端栈](https://github.com/CopilotKit/CopilotKit) ⭐️ 7.0/10 · GH Trending · 21:51
> 9. [github/copilot-sdk +310⭐: GitHub 发布 Copilot SDK，支持多平台集成 Copilot Agent](https://github.com/github/copilot-sdk) ⭐️ 7.0/10 · GH Trending · 21:51
> 10. [mvanhorn/last30days-skill +738⭐: mvanhorn/last30days-skill：聚合跨平台话题摘要的 AI 代理技能](https://github.com/mvanhorn/last30days-skill) ⭐️ 6.0/10 · GH Trending · 21:51

## AI 与工具

<a id="item-ai-tools-1"></a>
## [微软开源 pg_durable：PostgreSQL 内持久执行扩展](https://github.com/microsoft/pg_durable) ⭐️ 8.0/10
...
## [谷歌发布 Gemma 4 量化感知训练模型，优化移动与笔记本效率](https://blog.google/innovation-and-ai/technology/developers-tools/quantization-aware-training-gemma-4/) ⭐️ 8.0/10
...
## [Claude 是否导致 rsync 漏洞增加？](https://alexispurslane.github.io/rsync-analysis/) ⭐️ 8.0/10
...
## [我测试了家用实验室中的每一款 IP KVM](https://www.jeffgeerling.com/blog/2026/i-tested-every-ip-kvm/) ⭐️ 8.0/10
...
## [Ladybird 浏览器停止接受公开 PR，强化代码责任](https://simonwillison.net/2026/Jun/5/andreas-kling/#atom-everything) ⭐️ 8.0/10
...
## [AI 爱好者与怀疑者的竞赛：时间与熵的博弈](https://simonwillison.net/2026/Jun/4/ai-enthusiasts-ai-skeptics/#atom-everything) ⭐️ 8.0/10
...
## [关于 Conventional Commits 重形式轻内容的争论引发热议](https://sumnerevans.com/posts/software-engineering/stop-using-conventional-commits/) ⭐️ 7.0/10
...
## [国际空间站空气泄漏：宇航员紧急避难后安全返回](https://www.bbc.com/news/live/c4g44ew3g1kt) ⭐️ 6.0/10
...
<details><summary>参考链接</summary>
<ul>
<li><a href="https://www.newsweek.com/iss-air-leak-nasa-shelter-order-crew-evacuation-risk-12037320">NASA Astronauts Prepare to Evacuate as Space Station Air Leak ...</a></li>
<li><a href="https://www.usatoday.com/story/graphics/2026/06/05/iss-air-leak-nasa-graphics/90419828007/">Visuals show how an ISS air leak forced astronauts to shelter</a></li>
...
## [一位创始人分享三个最糟糕的风投经历](https://twitter.com/eastdakota/status/2062860530360959273) ⭐️ 6.0/10
...
## [毛细作用防堵塞的热淡化新法：无废水制取淡水](https://www.rochester.edu/newscenter/what-is-desalination-definition-ocean-water-704732/) ⭐️ 6.0/10
...
## [Apache Iceberg 提案：为 VARIANT 列添加虚拟字段元数据以优化查询](https://github.com/apache/iceberg/issues/16064) ⭐️ 8.0/10
...
## [ClickHouse 通过并行哈希连接等优化实现 26 倍连接性能提升](https://clickhouse.com/blog/clickhouse-fast-joins) ⭐️ 8.0/10
...
<details><summary>参考链接</summary>
<ul>
<li><a href="https://clickhouse.com/blog/clickhouse-fully-supports-joins-hash-joins-part2">ClickHouse Joins Under the Hood - Hash Join , Parallel Hash Join ...</a></li>
...
## [提议引入文件格式 API 以统一 Iceberg V3 特性支持](https://github.com/apache/iceberg/issues/12225) ⭐️ 7.0/10
...
<li><a href="https://www.dremio.com/blog/beyond-parquet-the-apache-iceberg-file-format-api-and-the-ai-era/">Beyond Parquet: The Apache Iceberg File Format API and the AI ...</a></li>
...
## [提议为 Iceberg REST API loadTable 响应添加修剪快照和元数据日志的查询参数](https://github.com/apache/iceberg/issues/15947) ⭐️ 7.0/10
...
<ul>
<li><a href="https://en.wikipedia.org/wiki/Apache_Iceberg">Apache Iceberg</a></li>
<li><a href="https://iceberg.apache.org/terms/">Terms - Apache Iceberg™</a></li>
...
## [Apache Hudi 提交 RFC 提出新 Table APIs 优化查询引擎集成](https://github.com/apache/hudi/issues/15195) ⭐️ 7.0/10
...
<li><a href="https://hudi.incubator.apache.org/docs/0.5.2/querying_data/">Querying Hudi Tables | Apache Hudi</a></li>
...
## [ClickStack 事件增量加速慢追踪的根因定位](https://clickhouse.com/blog/faster-root-cause-for-slow-traces-with-clickstack-event-deltas) ⭐️ 7.0/10
...
<details><summary>参考链接</summary>
<ul>
<li><a href="https://clickhouse.com/clickstack">ClickStack</a></li>
<li><a href="https://github.com/ClickHouse/ClickStack">ClickStack - the open-source observability stack for ... - GitHub</a></li>
<li><a href="https://app.daily.dev/posts/faster-root-cause-for-slow-traces-with-clickstack-event-deltas-5orihg5as">Faster root cause for slow traces with ClickStack Event Deltas | daily.dev</a></li>
...
## [提案：Kafka Connect Worker 需检测协调器进度以实施背压](https://github.com/apache/iceberg/issues/16389) ⭐️ 6.0/10
...
## [Apache Iceberg 拟在 LoadTableResponse 中暴露服务器分配的表 ID](https://github.com/apache/iceberg/issues/16399) ⭐️ 6.0/10
...
## [Iceberg REST Catalog 提议新增表与列标签字段](https://github.com/apache/iceberg/issues/15521) ⭐️ 6.0/10
